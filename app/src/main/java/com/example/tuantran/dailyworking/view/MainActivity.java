...
import com.example.tuantran.dailyworking.network.ApiClient;
import com.example.tuantran.dailyworking.network.ApiService;
import com.example.tuantran.dailyworking.network.model.Note;
import com.example.tuantran.dailyworking.network.model.User;
import com.example.tuantran.dailyworking.utils.MyDividerItemDecoration;
import com.example.tuantran.dailyworking.utils.PreUtils;
import com.example.tuantran.dailyworking.utils.RecyclerTouchListener;
            ...
            apiService
                ...
                .subscribeWith(new DisposableSingleObserver<User>() {
                    ...
                    public void onSuccess(User user) {
                        ...
                        PreUtils.storeAPIKey(getApplicationContext(), user.getApiKey());

                        Toast.makeText(getApplicationContext(),
                            "Device is registered successfully! ApiKey: " + PreUtils.getApiKey(getApplicationContext()),
